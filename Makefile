...
all: kosinski_compress kosinski_compress_asm kosinski_decompress kosinski_compress_d kosinski_decompress_d kosinski_compare kosinskim_compress kosinskim_decompress kosinskim_compress_d kosinskim_decompress_d kosinskim_compare
...
kosinskim_compress: main_moduled_compress.c lib/kosinski_moduled_compress.c lib/kosinski_decompress.c lib/kosinski_compress.c load_file_to_buffer.c lib/memory_stream.c
	$(CC) $(CFLAGS) $(CPPFLAGS) $(LDFLAGS) -o $@ $^ $(LIBS)

kosinskim_decompress: main_moduled_decompress.c lib/kosinski_moduled_decompress.c lib/kosinski_decompress.c lib/kosinski_compress.c load_file_to_buffer.c lib/memory_stream.c
	$(CC) $(CFLAGS) $(CPPFLAGS) $(LDFLAGS) -o $@ $^ $(LIBS)
